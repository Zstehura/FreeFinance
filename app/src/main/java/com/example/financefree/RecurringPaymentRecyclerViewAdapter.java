...
public class RecurringPaymentRecyclerViewAdapter extends RecyclerView.Adapter<RecurringPaymentRecyclerViewAdapter.ViewHolder> {
    ...
    public RecurringPaymentRecyclerViewAdapter(List<PlaceholderItem> items) {
        mValues = items;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ViewHolder(FragmentRecurringPaymentBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(FragmentRecurringPaymentBinding binding) {
